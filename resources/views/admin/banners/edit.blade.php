      ...
      <div class="card-body">
        <form method="POST" action="{{route('admin.banners.update', $banner->id)}}" enctype="multipart/form-data">
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-10">
              <input type="text" class="form-control"name="name" value="{{ $banner->name }}" id="basic-default-name" placeholder="Category name" required/>
            </div>
          </div>
          <div class="row mb-3">
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-10">
                    ...
                    <input class="form-check-input" type="radio" {{$banner->status ? 'checked': ''}}  value="1" id="Active" name="status" />
                    <label class="form-check-label" for="defaultCheck1"> Active </label>

                  <div class="form-check">
                    <input class="form-check-input" type="radio" {{$banner->status ? '' : 'checked'}} value="0" id="InActive" name="status"  />
