                    ...
                    <div class="col-lg-6 col-md-5">
                        <div class="header__top__right">
                            <div class="header__top__links">
                                <a href="{{ route('website.login') }}">Sign in</a>
                                <a href="#">FAQs</a>
                            </div>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-3">
                    <div class="header__logo">
                        <a href="{{ route('website.index') }}"><img src="{{ asset('assets/img/MADMAX.png') }}"  width="170px" alt=""></a>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-3">
                    <div class="header__nav__option">
                        ...
                        <a href="{{ route('website.cart') }}"><img src="{{ asset('assets/img/icon/cart.png') }}" alt=""> <span>0</span></a>
                        <div class="price">$0.00</div>
                    </div>
                </div>
            </div>
